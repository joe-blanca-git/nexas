using Nexas.Lemon.Landing.Api.Extensions;
using Nexas.Lemon.Landing.Api.Middlewares;
using Nexas.Lemon.Landing.Api.Services;
using Nexas.Lemon.Landing.Api.Hubs;
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Nexas.Lemon.Landing.Api v1");
});
