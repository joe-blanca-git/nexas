...
namespace Nexas.Infrastructure.Migrations
{
    ...
    [Migration("20260810143122_UpdateFinancialTaxPercentagePrecision")]
    partial class UpdateFinancialTaxPercentagePrecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.CourseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.CourseRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.FinancialClosing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("NexasFeesTotal")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.FinancialClosingItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("NexasFeeValue")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.FinancialTax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.ForumCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.ForumMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.ForumTopic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketTimeline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.FinancialClosingItem", b =>
                {
                    b.HasOne("Nexas.Domain.Entities.FinancialClosing", "FinancialClosing")
                        .WithMany("Items")
                        .HasForeignKey("FinancialClosingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nexas.Domain.Entities.Purchase", "Purchase")
                        .WithMany()
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.ForumMessage", b =>
                {
                    b.HasOne("Nexas.Domain.Entities.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Nexas.Domain.Entities.ForumTopic", "Topic")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.ForumTopic", b =>
                {
                    ...
                    b.HasOne("Nexas.Domain.Entities.ForumCategory", "Category")
                        .WithMany("Topics")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.Ticket", b =>
                {
                    b.HasOne("Nexas.Domain.Entities.TicketCategory", "Category")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketAttachment", b =>
                {
                    b.HasOne("Nexas.Domain.Entities.TicketMessage", "Message")
            ...
            modelBuilder.Entity("Nexas.Domain.Entities.TicketMessage", b =>
                {
                    b.HasOne("Nexas.Domain.Entities.Ticket", "Ticket")
                        .WithMany("Messages")
