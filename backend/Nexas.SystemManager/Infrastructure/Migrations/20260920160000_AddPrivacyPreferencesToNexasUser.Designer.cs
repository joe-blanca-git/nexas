...
{
    [DbContext(typeof(SystemManagerDbContext))]
    [Migration("20260920160000_AddPrivacyPreferencesToNexasUser")]
    partial class AddPrivacyPreferencesToNexasUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexas.SystemManager.Domain.Entities.SystemApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Nexas.SystemManager.Domain.Entities.NexasUser", null)
                        .WithMany()
